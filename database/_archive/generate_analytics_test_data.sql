-- 🎯 SCRIPT DE GÉNÉRATION DE DONNÉES DE TEST ANALYTICS
...
INSERT INTO analytics_page_views (session_id, page_path, page_title, referrer, time_on_page, created_at)
VALUES 
  ('session_test_1', '/', 'Accueil - Finitio', 'https://google.com', 45, NOW() - INTERVAL '1 day'),
  ('session_test_1', '/inscription', 'Inscription - Finitio', '/', 120, NOW() - INTERVAL '1 day' + INTERVAL '45 seconds'),
  ('session_test_2', '/', 'Accueil - Finitio', 'https://facebook.com', 30, NOW() - INTERVAL '2 hours'),
  ('session_test_2', '/connexion', 'Connexion - Finitio', '/', 90, NOW() - INTERVAL '2 hours' + INTERVAL '30 seconds'),
  ('session_test_3', '/dashboard-client', 'Dashboard Client - Finitio', 'direct', 180, NOW() - INTERVAL '30 minutes'),
  ('session_test_4', '/', 'Accueil - Finitio', 'https://linkedin.com', 60, NOW() - INTERVAL '3 hours'),
  ('session_test_4', '/projets', 'Projets - Finitio', '/', 240, NOW() - INTERVAL '3 hours' + INTERVAL '1 minute'),
  ('session_test_5', '/', 'Accueil - Finitio', 'https://twitter.com', 25, NOW() - INTERVAL '5 hours'),
  ('session_test_5', '/inscription', 'Inscription - Finitio', '/', 150, NOW() - INTERVAL '5 hours' + INTERVAL '25 seconds');
