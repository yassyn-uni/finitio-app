-- 🎯 SCRIPT DE GÉNÉRATION DE DONNÉES DE TEST ANALYTICS - VERSION FINALE
...
-- ✅ 2. GÉNÉRER DES PAGES VUES DE TEST (AVEC page_name obligatoire)
...
INSERT INTO analytics_events (session_id, event_name, event_category, event_label, event_data, created_at)
VALUES 
  ('session_test_1', 'hero_cta_click', 'engagement', 'cta_primary', '{"cta_type":"primary","cta_text":"Commencer gratuitement","location":"hero_section"}', NOW() - INTERVAL '1 day'),
  ('session_test_1', 'navbar_navigation', 'navigation', 'menu_click', '{"nav_item":"inscription","current_page":"/"}', NOW() - INTERVAL '1 day' + INTERVAL '45 seconds'),
  ('session_test_2', 'hero_stat_interaction', 'engagement', 'stat_click', '{"stat_name":"Projets réalisés","stat_value":"15K+","interaction_type":"click"}', NOW() - INTERVAL '2 hours'),
  ('session_test_2', 'navbar_navigation', 'navigation', 'menu_click', '{"nav_item":"connexion","current_page":"/"}', NOW() - INTERVAL '2 hours' + INTERVAL '30 seconds'),
  ('session_test_3', 'dashboard_module_click', 'engagement', 'module_access', '{"module_name":"Mes projets","module_type":"primary"}', NOW() - INTERVAL '30 minutes'),
  ('session_test_4', 'hero_cta_click', 'engagement', 'cta_secondary', '{"cta_type":"secondary","cta_text":"Se connecter","location":"hero_section"}', NOW() - INTERVAL '3 hours'),
  ('session_test_4', 'navbar_navigation', 'navigation', 'menu_click', '{"nav_item":"projets","current_page":"/"}', NOW() - INTERVAL '3 hours' + INTERVAL '1 minute'),
  ('session_test_5', 'hero_cta_click', 'engagement', 'cta_primary', '{"cta_type":"primary","cta_text":"Commencer gratuitement","location":"hero_section"}', NOW() - INTERVAL '5 hours');
