-- 🏗️ SYSTÈME COMPLET UTILISATEURS + FOURNISSEURS POUR FINITIO
-- Ce script crée/complète la table users ET les tables fournisseurs
-- Solution complète pour le problème de colonnes manquantes
...
CREATE POLICY IF NOT EXISTS "Users peuvent voir leur profil" ON users
