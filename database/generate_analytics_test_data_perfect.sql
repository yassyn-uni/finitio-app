-- 🎯 SCRIPT DE GÉNÉRATION DE DONNÉES DE TEST ANALYTICS - VERSION PARFAITE
...
-- ✅ 4. GÉNÉRER DES INSCRIPTIONS DE TEST (AVEC LES VRAIES COLONNES)
...
VALUES 
  (gen_random_uuid(), 'test1@finitio.com', 'client', 'Test Client 1', 'email_password', 'https://google.com', 'google', 'organic', 'search', '{"source":"hero_cta","device":"desktop"}', NOW() - INTERVAL '1 day'),
  (gen_random_uuid(), 'test2@finitio.com', 'prestataire', 'Test Prestataire 1', 'email_password', 'https://facebook.com', 'facebook', 'social', 'post', '{"source":"navbar_cta","device":"mobile"}', NOW() - INTERVAL '5 hours'),
  (gen_random_uuid(), 'test3@finitio.com', 'architecte', 'Test Architecte 1', 'email_password', 'direct', 'direct', 'direct', 'direct', '{"source":"hero_cta","device":"tablet"}', NOW() - INTERVAL '2 hours');
...
-- - 4 connexions (3 succès, 1 échec avec message d'erreur)
