  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-red-100 p-6">
      ...
      <div className="animate-fade-in-up mb-8">
        ...
        <div className="flex justify-center mt-4">
          <div className="flex items-center gap-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full shadow-lg">
            ...
            <span className="text-sm font-medium text-gray-700">Profil actif - Visible par les clients</span>
          </div>
        </div>
      </div>
          ...
          >
            <div className="card-interactive animate-fade-in-up bg-white/80 backdrop-blur-sm border border-white/20 h-full">
              ...
              <div className="relative p-6 flex flex-col items-center text-center h-full">
                ...
                <div className="mt-4 flex items-center text-orange-500 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="text-center p-4 rounded-xl bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200">
              <div className="text-2xl font-bold text-blue-600 animate-pulse-soft">8</div>
              <div className="text-sm text-blue-800">Devis soumis</div>
            </div>
            
            <div className="text-center p-4 rounded-xl bg-gradient-to-br from-green-50 to-green-100 border border-green-200">
              <div className="text-2xl font-bold text-green-600 animate-pulse-soft">3</div>
              <div className="text-sm text-green-800">Projets acceptés</div>
            </div>
            
            <div className="text-center p-4 rounded-xl bg-gradient-to-br from-orange-50 to-orange-100 border border-orange-200">
              <div className="text-2xl font-bold text-orange-600 animate-pulse-soft">2</div>
              <div className="text-sm text-orange-800">En négociation</div>
            </div>
            
            <div className="text-center p-4 rounded-xl bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200">
              <div className="text-2xl font-bold text-purple-600 animate-pulse-soft">95%</div>
              <div className="text-sm text-purple-800">Taux satisfaction</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden -z-10">
        <div className="absolute top-1/4 left-1/4 w-2 h-2 bg-orange-400 rounded-full animate-float opacity-30"></div>
        <div className="absolute top-3/4 right-1/4 w-1 h-1 bg-red-400 rounded-full animate-float opacity-40" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/2 left-3/4 w-1.5 h-1.5 bg-amber-400 rounded-full animate-float opacity-20" style={{ animationDelay: '2s' }}></div>
        <div className="absolute bottom-1/4 left-1/2 w-1 h-1 bg-yellow-400 rounded-full animate-float opacity-35" style={{ animationDelay: '0.5s' }}></div>
      </div>
    </div>
  );
}
